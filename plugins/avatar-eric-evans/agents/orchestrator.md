...
description: >
  Intent detection and routing for Eric Evans's engineering avatar.
...
|------------|----------|---------|
| Ask a question | consult | "what does Evans think about...", "how would you approach...", question marks |
| Get coached through a practice | coach | "walk me through...", "help me apply...", "show me how..." |
| Review work against principles | review | "review this", "check my code", "what would Evans say about..." |
...
1. Read `skills/eric-evans/SKILL.md` for principles, cycle, vocabulary
...
4. Load relevant reference files based on the interaction:
   - Principles: `skills/eric-evans/references/principles.md`
   - Anti-patterns: `skills/eric-evans/references/anti-patterns.md`
   - Vocabulary: `skills/eric-evans/references/vocabulary.md`
</context_loading>
