---
description: "Monarch Money budget overview — current month budget vs actual spending"
...
Load the monarch agent and skill, then run the **budget** task.
...
- "See cash flow" -> run the cashflow task
- "I'm good" -> end
