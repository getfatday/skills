...
At a higher level: Observe friction → Tidy first? → Tidy (if economics justify) → Behavior change → Observe → ...

At the product level: Explore (cheap experiments) → Expand (scale) → Extract (optimize) → (new Explore)
</cycle>
