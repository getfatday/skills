---
description: "Engineering plan with Boris Cherny — domain gray areas, TDD-influenced decomposition, principled verification"
---

# Engineering Plan (Boris Cherny)

## Setup

1. Read `skills/boris-cherny/SKILL.md`
2. Read `skills/boris-cherny/references/principles.md`
3. Read `AVATAR.md`

## Flow

Create an engineering-informed plan. Cherny's planning approach:

### Gray Areas (Cherny would ask these)
Surface 3-4 questions Cherny would ask before starting:
...
Each task has a verify criterion grounded in Cherny's principles:
