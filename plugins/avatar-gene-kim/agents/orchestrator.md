...
description: >
  Intent detection and routing for Gene Kim's engineering avatar.
...
|------------|----------|---------|
| Ask a question | consult | "what does Kim think about...", "how would you approach...", question marks |
| Get coached through a practice | coach | "walk me through...", "help me apply...", "show me how..." |
| Review work against principles | review | "review this", "check my code", "what would Kim say about..." |
...
1. Read `skills/gene-kim/SKILL.md` for principles, cycle, vocabulary
...
4. Load relevant reference files based on the interaction:
   - Principles: `skills/gene-kim/references/principles.md`
   - Anti-patterns: `skills/gene-kim/references/anti-patterns.md`
   - Vocabulary: `skills/gene-kim/references/vocabulary.md`
</context_loading>
